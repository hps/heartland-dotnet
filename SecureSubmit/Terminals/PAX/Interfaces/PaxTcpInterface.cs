...
namespace SecureSubmit.Terminals.PAX {
    ...
    internal class PaxTcpInterface : IDeviceCommInterface {
        ...
        public void Connect() {
            ...
            _client.Connect(_settings.IpAddress, Int32.Parse(_settings.Port));
        ...
        public byte[] Send(IDeviceMessage message) {
            ...
            for (int i = 0; i < 3; i++) {
                ...
                else if (code == ControlCodes.EOT) throw new HpsMessageException("Terminal returned EOT for the current message.");
