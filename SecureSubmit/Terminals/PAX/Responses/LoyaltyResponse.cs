...
namespace SecureSubmit.Terminals.PAX {
    public class LoyaltyResponse : PaxDeviceResponse {
        public string AuthorizationCode { get; set; }
        //TODO: public decimal? BalanceAmount { get; set; }
        ...
        internal LoyaltyResponse(byte[] buffer)
            : base(buffer, PAX_MSG_ID.T09_RSP_DO_LOYALTY) {
        }
