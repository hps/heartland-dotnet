...
using SecureSubmit.Services.Fluent.GiftCard;

// ReSharper disable once CheckNamespace
namespace SecureSubmit.Services.GiftCard
{
    public class HpsGiftCardService : HpsSoapGatewayService
    {
        ...
        public ActivateBuilder Activate(decimal amount, HpsGiftCard giftCard)
        {
            return new ActivateBuilder(ServicesConfig, amount, giftCard);
        }

        public AddValueBuilder AddValue(decimal amount, HpsGiftCard giftCard)
        {
        ...
        {
            return new BalanceBuilder(ServicesConfig, giftCard);
        }

        public DeactivateBuilder Deactivate(HpsGiftCard giftCard)
        {
            return new DeactivateBuilder(ServicesConfig, giftCard);
        }

        public ReplaceBuilder Replace(HpsGiftCard oldGiftCard, HpsGiftCard newGiftCard)
        {
            return new ReplaceBuilder(ServicesConfig, oldGiftCard, newGiftCard);
        }

        public RewardBuilder Reward(decimal amount, HpsGiftCard giftCard)
        {
            return new RewardBuilder(ServicesConfig, amount, giftCard);
        }

        public SaleBuilder Sale(decimal amount, HpsGiftCard giftCard)
        {
            return new SaleBuilder(ServicesConfig, amount, giftCard);
        }
        ...
        public VoidBuilder Void(int transactionId)
        {
            return new VoidBuilder(ServicesConfig, transactionId);
        }

        [Obsolete("This 'Activate' method is deprecated, please use the fluent version instead.")]
        public HpsGiftCardActivate Activate(decimal amount, string currency, HpsGiftCard giftCard)
        {
            HpsInputValidation.CheckAmount(amount);
        ...
        public HpsGiftCardAddValue AddValue(decimal amount, string currency, HpsGiftCard giftCard)
        {
            HpsInputValidation.CheckAmount(amount);
            HpsInputValidation.CheckCurrency(currency);
        ...
        public HpsGiftCardBalance GetBalance(HpsGiftCard giftCard)
        {
            /* Build the transaction request. */
            var transaction = new PosRequestVer10Transaction
            {
        ...
        /// <param name="giftCard">The gift card information.</param>
        /// <returns>The <see cref="HpsGiftCardBalance"/>.</returns>
        public HpsGiftCardDeactivate DeactivateCard(HpsGiftCard giftCard)
        {
            /* Build the transaction request. */
            var transaction = new PosRequestVer10Transaction
            {
        ...
        public HpsGiftCardReplace ReplaceCard(HpsGiftCard oldGiftCard, HpsGiftCard newGiftCard)
        {
            /* Build the transaction request. */
            var transaction = new PosRequestVer10Transaction
            {
        ...
        public HpsGiftCardReward Reward(HpsGiftCard giftCard, decimal amount, string currency = "usd",
        ...
        /// <returns>The <see cref="HpsGiftCardReward"/>.</returns>
        public HpsGiftCardVoid VoidTransaction(int transactionId)
        {
            /* Build the transaction request. */
            var transaction = new PosRequestVer10Transaction
            {
        ...
        /// <param name="currency">Identifies the currency of a financial transaction ("usd" or "points")</param>
        /// <returns>The <see cref="HpsGiftCardReward"/>.</returns>
        public HpsGiftCardReversal Reverse(HpsGiftCard giftCard, decimal amount, string currency = "usd")
        {
            HpsInputValidation.CheckAmount(amount);
            HpsInputValidation.CheckCurrency(currency);
        ...
        /// <param name="currency">Identifies the currency of a financial transaction ("usd" or "points")</param>
        /// <returns>The <see cref="HpsGiftCardReward"/>.</returns>
        public HpsGiftCardReversal Reverse(int transactionId, decimal amount, string currency = "usd")
        {
            HpsInputValidation.CheckAmount(amount);
        ...
        private HpsGiftCardAddValue SubmitAddValue(PosRequestVer10Transaction transaction)
        {
            var rsp = DoTransaction(transaction).Ver10;
        ...
        /// <returns>The <see cref="HpsGiftCardActivate"/>.</returns>
        private HpsGiftCardActivate SubmitActivation(PosRequestVer10Transaction transaction)
        {
            var rsp = DoTransaction(transaction).Ver10;
        ...
        /// <param name="transaction">The gateway response.</param>
        /// <returns>The <see cref="HpsGiftCardActivate"/>.</returns>
        private HpsGiftCardReversal SubmitReversal(PosRequestVer10Transaction transaction)
        {
            var rsp = DoTransaction(transaction).Ver10;
