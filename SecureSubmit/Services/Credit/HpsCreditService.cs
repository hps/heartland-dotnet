...
namespace SecureSubmit.Services.Credit
{
    ...
    public class HpsCreditService : HpsSoapGatewayService
    {
        ...
        public ChargeBuilder.ChargePaymentTypeBuilder Charge(decimal amount)
        {
            HpsInputValidation.CheckAmount(amount);
            return new ChargeBuilder.ChargePaymentTypeBuilder(new ChargeBuilder(ServicesConfig, amount));
        }

        public AuthBuilder.AuthPaymentTypeBuilder Authorize(decimal amount)
        {
            HpsInputValidation.CheckAmount(amount);
            return new AuthBuilder.AuthPaymentTypeBuilder(new AuthBuilder(ServicesConfig, amount));
        }

        public CaptureBuilder Capture(int transactionId)
        {
            return new CaptureBuilder(ServicesConfig, transactionId);
        }

        public EditBuilder.EditUsingBuilder Edit()
        {
            return new EditBuilder.EditUsingBuilder(new EditBuilder(ServicesConfig));
        }

        public RefundBuilder.RefundUsingBuilder Refund(decimal amount)
        {
            HpsInputValidation.CheckAmount(amount);
            return new RefundBuilder.RefundUsingBuilder(new RefundBuilder(ServicesConfig, amount));
        }
        ...
        public VerifyBuilder.VerifyUsingBuilder Verify()
        {
            return new VerifyBuilder.VerifyUsingBuilder(new VerifyBuilder(ServicesConfig));
        }
        ...
        public BalanceInquiryBuilder.BalanceInquiryUsingBuilder PrePaidBalanceInquiry()
        {
            return new BalanceInquiryBuilder.BalanceInquiryUsingBuilder(new BalanceInquiryBuilder(ServicesConfig));
        }

        public CpcEditBuilder CpcEdit(int transactionId)
        {
