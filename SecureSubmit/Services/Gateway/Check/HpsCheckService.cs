// --------------------------------------------------------------------------------------------------------------------
// <copyright file="HpsCheckService.cs" company="Heartland Payment Systems">
//   Copyright (c) Heartland Payment Systems. All rights reserved.
// </copyright>
// <summary>
//   The HPS check service.
// </summary>
// --------------------------------------------------------------------------------------------------------------------
...
{
    public class HpsCheckService : HpsGatewayService
    {
        ...
        public HpsCheckResponse Sale(checkActionType action, HpsCheck check, decimal amount)
        {
            ...
            CheckSaleReqBlock1Type block1 = ((PosCheckSaleReqType)transaction.Item).Block1;
        ...
        private static List<HpsCheckResponseDetails> GetResponseDetails(IEnumerable<CheckRspInfoType> responseInfo)
        {
            ...
            foreach (CheckRspInfoType info in responseInfo)
            {
