// --------------------------------------------------------------------------------------------------------------------
// <copyright file="HpsChargeService.cs" company="Heartland Payment Systems">
...
namespace SecureSubmit.Services.Credit
{
    ...
    public class HpsCreditService : HpsGatewayService
    {
        ...
        /// <param name="clientTransactionId">The optional client transaction ID.</param>
        /// <returns>The <see cref="HpsVoid"/>.</returns>
        public HpsVoid Void(int transactionId, long? clientTransactionId = null)
        {
            /* Build the transaction request. */
            var transaction = new PosRequestVer10Transaction
            {
