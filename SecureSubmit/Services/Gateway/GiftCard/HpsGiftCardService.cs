// --------------------------------------------------------------------------------------------------------------------
// <copyright file="HpsGiftCardService.cs" company="Heartland Payment Systems">
...
{
    /// <summary>The HPS gift card service.</summary>
    public class HpsGiftCardService : HpsGatewayService
    {
        ...
        public HpsGiftCardBalance Balance(HpsGiftCard giftCard)
        {
            /* Build the transaction request. */
            var transaction = new PosRequestVer10Transaction
            {
        ...
        /// <param name="giftCard">The gift card information.</param>
        /// <returns>The <see cref="HpsGiftCardBalance"/>.</returns>
        public HpsGiftCardDeactivate Deactivate(HpsGiftCard giftCard)
        {
            /* Build the transaction request. */
            var transaction = new PosRequestVer10Transaction
            {
        ...
        public HpsGiftCardReplace Replace(HpsGiftCard oldGiftCard, HpsGiftCard newGiftCard)
        {
            /* Build the transaction request. */
            var transaction = new PosRequestVer10Transaction
            {
        ...
        /// <returns>The <see cref="HpsGiftCardReward"/>.</returns>
        public HpsGiftCardVoid Void(int transactionId)
        {
            /* Build the transaction request. */
            var transaction = new PosRequestVer10Transaction
            {
